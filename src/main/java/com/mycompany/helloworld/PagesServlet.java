...
import com.axaih.webservice.AbstractPagesServlet;
...
@Singleton
public class PagesServlet extends AbstractPagesServlet {
	...
	class TemplatePageName {
		...
		public final static String HOME = "soy.mycompany.helloworld.Home.boot"; 
	...
	final static Logger logger = LoggerFactory.getLogger(PagesServlet.class);
	...
	public PagesServlet(
			...
			ConfigurationService configurationService) {
		super( closureTemplateViewResolver);

		Builder<String, String> mapBuilder = ImmutableMap.builder();
		this.configurationService = configurationService;
		try {

			mapBuilder.put(Cmd.home, TemplatePageName.HOME);
		...
		logger.info("home controller constructor");
