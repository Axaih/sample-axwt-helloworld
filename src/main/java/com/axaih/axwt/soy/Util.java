...
public class Util {
	...
	/**
	 * Convert all data stored in a POJO or Map<String, Object> into a format
	 * compatible with Soy's DataMap. This method will convert nested POJOs to a
	 * corresponding nested Maps.
	 * 
	 * @param obj
	 *            The Map or POJO who's data should be converted.
	 ...
	 */
	public static List<Object> toSoyCompatibleMapList(List<?> objList) {
		// quoteList and scoreList to map<Quote,Score>
		List<Object> list = null;
		if (objList != null) {
			list = Lists.transform(objList, new Function<Object, Object>() {
				public Object apply(Object object) {

					Object ret = toSoyCompatibleObjects(object);
					return ret;
				}
			});
		}
	...
	/**
	 * Convert an object (or graph of objects) to types compatible with Soy
	 * (data able to be stored in SoyDataMap). This will convert: - POJOs to
	 * Maps - Iterables to Lists - all strings and primitives remain as is.
	 * 
	 * @param obj
	 ...
	 * 
	 * @param pojo
	 *            The Java pojo object with standard getters and setters.
	...
	/**
	 * Merge two SoyMapData resources. If the two maps to merge contain
	 * duplicate key names, source s2 will overwrite s1.
	 * 
	 * @param s1
	 *            1st resource map.
	 * @param s2
	...
	/**
	 * Take a list of SoyMsgBundles and merge. This is a little hacky but to
	 * make life easier we'll use an internal/restricted class:
	 * SoyMsgBundleImpl.
	 * 
	 * @param soyMsgBundles
	...
	public static SoyMsgBundle mergeMsgBundles(List<SoyMsgBundle> soyMsgBundles) {
		...
		Preconditions.checkArgument(
				soyMsgBundles != null && soyMsgBundles.size() > 0,
				"No MsgBundels defined");
